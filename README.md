...
Plugin `0.4.19` primarily targets compatibility with DeepSeek Harness `dsh-v0.1.7-rc.1`, while also supporting `dsh-v0.1.6-alpha.2` and earlier settings hosts. It supports `dsh-v0.1.1-rc.2` through the legacy
...
Desktop endpoints must use a compatible Harness carrier. Plugin `0.4.19` selects the legacy
